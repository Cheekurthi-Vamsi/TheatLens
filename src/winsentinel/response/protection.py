...
A process is protected when any of these hold:
    ...
    * it is WinSentinel's own process (never let the tool suspend or kill itself).
...
from winsentinel.core.models import IntegrityLevel, ProcessInfo
...
class ProtectionPolicy:
    ...
    def evaluate(self, process: ProcessInfo) -> ProtectionVerdict:
        ...
        if process.pid == self._own_pid:
            reasons.append("this is WinSentinel's own process")

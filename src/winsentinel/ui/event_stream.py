"""Line-oriented live event stream for ``winsentinel monitor`` (human or JSON Lines).
...
from winsentinel.core.models import AddressScope, Alert, DetectionResult, EventType, SecurityEvent
from winsentinel.ui import colors
from winsentinel.ui.alert_views import alert_stream_text
from winsentinel.ui.detection_views import detection_stream_text
from winsentinel.ui.formatting import sanitize_display
from winsentinel.ui.json_output import json_line

...
WinSentinel never requests elevation. It detects the current token's state so the CLI can tell
...
from winsentinel.utils.windows import is_current_process_elevated, is_windows

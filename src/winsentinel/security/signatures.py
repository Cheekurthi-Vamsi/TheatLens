...
from winsentinel.core.models import SignatureInfo, SignatureSource, SignatureStatus
from winsentinel.security.hashing import (
    FileFingerprint,
...
PACKAGE_DETAIL: Final = (
    ...
    "individual files. WinSentinel does not verify package signatures; the install location "

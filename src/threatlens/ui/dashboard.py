...
from threatlens.ui.event_stream import format_event
...
if TYPE_CHECKING:
    ...
    from threatlens.response.protection import ProtectionVerdict
...
class Dashboard:
    ...
    def _start_trim(self) -> None:
        ...
        self._trim_thread = threading.Thread(
            target=self._run_trim, name="threatlens-clear-ram", daemon=True
        )

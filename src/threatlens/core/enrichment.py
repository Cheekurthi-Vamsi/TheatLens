...
from threatlens.collectors.process_collector import ProcessEnricher
...
class EnrichmentWorker:
    ...
    def start(self) -> None:
        self._thread = threading.Thread(target=self._run, name="threatlens-enrichment", daemon=True)
        self._thread.start()

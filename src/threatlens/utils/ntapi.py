...
from threatlens.errors import PlatformNotSupportedError
from threatlens.utils.time import FILETIME_EPOCH_OFFSET, HUNDRED_NS_PER_SECOND
...
def query_image_name_by_pid(pid: int) -> str:
    ...
    :class:`threatlens.utils.windows.DevicePathResolver`.
    """
    if sys.platform != "win32":

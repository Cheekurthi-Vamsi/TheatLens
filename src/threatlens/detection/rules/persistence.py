...
class NewAutorunEntry(Rule):
    meta = RuleMetadata(
        ...
        rationale=(
            ...
            "entry that appears while ThreatLens is watching is worth confirming; the risk is "
        ...
        recommendation=(
            ...
            "Startup folder) if it is unwanted; ThreatLens only reports, never modifies it."
        ),
    )
